class RouteTable(object):
    ...
    def create_tags(self, route_table_id, name):
        ...
        self.client.create_tags(Resources=[route_table_id], Tags=[{'Key': 'Name', 'Value': name}])
        print(f"Tags created for Route Table {route_table_id} with Name: {name}")



    def create_route(self, route_table_id, gateway_id, destination_cidr_block='0.0.0.0/0'):
        ...
        print(f"Route created in Route Table {route_table_id} to Gateway {gateway_id} for CIDR block {destination_cidr_block}")
